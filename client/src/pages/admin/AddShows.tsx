  ...
  return nowPlayingMovies.length > 0 ? (
    <>
              ...
              <div className="relative rounded-lg overflow-hidden">
                ...
                <div className="text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0">
                  ...
                  <p className="text-gray-300">
                    {kConverter({ num: movie.vote_count })}Votes
                  </p>
                </div>
              </div>
      ...
      <div className="mt-6">
       ...
       <button onClick={handleSubmit} disabled={addingShow} className="bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary-dull transition-all cursor-pointer">
        Add Show
        </button>
    </>
  ) : (

...
const MovieDetails = () => {
  ...
  useEffect(() => {
    const getShow = () => {
      const foundMovie = dummyShowsData.find((item) => item._id === id);
    ...
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50 ">
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        <img
          ...
          alt=""
          className="max-md:mx-auto rounded-xl h-104 max-2-70 object-cover"
        />
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <p>
            {timeFormat({ minutes: show.movie.runtime })} •{" "}

...
const SeatLayout = () => {
  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-116 lg:px-40 py-30 md:pt-50">
      <div className="w-60 bg-primary/10 border border-primary/20 rounded-2xl py-10 h-max md:sticky md:top-30">
